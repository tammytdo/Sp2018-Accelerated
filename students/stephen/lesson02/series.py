...
def fibonacci(n):
    """Return the nth value of the Fibonacci series. Index starting with 1."""
    if n == 1:
        return 0
    elif n == 2:
        return 1
...
# with the values 2 and 1 rather than 0 and 1. The resulting series looks
# like this:
# 2, 1, 3, 4, 7, 11, 18, 29, ...
# In your series.py module, add a new function, lucas, that returns
# the nth value in the lucas numbers series.
# Ensure that your function has a well-formed docstring.


def lucas(n):
    """Return the nth value of the Lucas series. Index starting with 1."""
    if n == 1:
        return 2
    elif n == 2:
        return 1
...
# identical formula. Add a third function called sum_series with one
# required parameter and two optional parameters. The required parameter
# will determine which element in the series to print. The two optional
# parameters will have default values of 0 and 1 and will
...
# will produce values from the lucas numbers. Other values for
# the optional parameters will produce other series.


def sum_series(n, a=0, b=1):
    """
    Return the nth term of a series where every term is the sum
    of the previous two terms. The a and b parameters specify the first and
    second values, respectively, in the series. Index starting with 1.
    """
    if n == 1:
        return a
    elif n == 2:
...
# Rewrite the Fibonacci and lucas functions with sum_series function
