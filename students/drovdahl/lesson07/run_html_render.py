...
# page = hr.Element()
#
# page.append("Step 1 - Here is a paragraph of text -- there could be more of them, "
#             "Step 1 - but this is enough  to show that we can do some text")
#
# page.append("Step 1 - And here is another piece of text -- you should be able to add any number")
#
...
# body = hr.Body()
#
# body.append(hr.P("Step 2 - Here is a paragraph of text -- there could be more of them, "
#                  "Step 2 - but this is enough  to show that we can do some text"))
#
# body.append(hr.P("Step 2 - And here is another piece of text -- you should be able to add any number"))
#
# page.append(body)
#
